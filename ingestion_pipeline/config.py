...
class Config:
    ...
    # Chunking
    # int() is required: env vars arrive as strings and LangChain compares them numerically
    CHUNK_SIZE = int(os.getenv("CHUNK_SIZE", "1500")) # Larger chunks → better semantic units
    ...
    # Only chunks with LLM-identified edges go to Milvus
    INDEX_ONLY_CONNECTED_CHUNKS = os.getenv("INDEX_ONLY_CONNECTED_CHUNKS", "true").lower() == "true"
